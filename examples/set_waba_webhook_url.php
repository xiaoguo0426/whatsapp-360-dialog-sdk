...
$override_all = true;
$setWabaWebhookResponse = $client->setWabaWebhookUrl($webhook_url, $headers, $override_all);

var_dump($setWabaWebhookResponse->getMessage());
var_dump($setWabaWebhookResponse->getData());
